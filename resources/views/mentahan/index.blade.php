    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                ...
                {{-- <button onclick="cetakmentahan('{{ route('mentahan.cetak_mentahan') }}')"
                    class="btn btn-info btn-xs btn-flat"><i class="fa fa-id-card"></i> Cetak mentahan</button> --}}
            </div>
...
<script>
    let table;
        ...
        function addForm(url) {
            ...
            $('#modal-form2 .modal-title').text('Tambah mentahan');
